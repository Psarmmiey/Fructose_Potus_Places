...
public class MainActivity extends AppCompatActivity
	...
	public static final String EXTRA_MESSAGE_LAT = "com.psarmmiey.placesViewer.MESSAGE";
	public static final String EXTRA_MESSAGE_LONG = "com.psarmmiey.placesViewer.LONGITUDE";
	...
	public void sendMessage(View view) {
		...
		// TextInputLayout latEditText = (TextInputLayout) findViewById(R.id.latTextInputLayout);
		String latitude = "" + getMLat();
		String longitude = "" + getmLong();
		intent.putExtra(EXTRA_MESSAGE_LAT, latitude);
		intent.putExtra(EXTRA_MESSAGE_LONG, longitude);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FloatingActionButton addPlaceFab = (FloatingActionButton) findViewById(R.id.addPlaceFab);
